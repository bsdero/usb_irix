...
##################################################################################
DESCRIPTION_FILE="pciehci.version"
...
echo "#define PCIEHCI_DRV_SHORT_NAME                \"$SHORTNAME\"">>$CONFIG_H_FILE
echo "#define PCIEHCI_DRV_LONG_NAME                 \"$LONGNAME\"">>$CONFIG_H_FILE
echo "#define PCIEHCI_DRV_VERSION                   \"$VERSION\"">>$CONFIG_H_FILE
echo "#define PCIEHCI_DRV_SHORT_VERSION             \"$SHORTVERSION\"">>$CONFIG_H_FILE
echo "#define PCIEHCI_DRV_SEQ                       \"$SEQ\"">>$CONFIG_H_FILE
echo "#define PCIEHCI_BUILD_DATE                    \"$BUILDDATE\"">>$CONFIG_H_FILE
echo >>$CONFIG_H_FILE
echo >>$CONFIG_H_FILE
